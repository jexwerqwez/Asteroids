...
void print_a(int x, int y, char cell_type) {
    ...
    addstr(three_cells);
    move(y+4,x);
    addstr(one_cell); move(y+4,x+2); addstr(one_cell);
}
...
void print_t(int x, int y, char cell_type) {
    ...
    addstr(three_cells);
    move(y+1, x);
    move(y+1,x+1);addstr(one_cell); 
    move(y+2,x);
    move(y+2,x+1);addstr(one_cell); 
    move(y+3,x);
    move(y+3,x+1);addstr(one_cell); 
    move(y+4,x);
...
void print_n(int x, int y, char cell_type) {
    ...
    char three_cells[4] = {cell_type,cell_type,cell_type};
    move(y,x);
    addstr(one_cell); move(y,x+3); addstr(one_cell); 
    move(y+1, x);
    addstr(one_cell); move(y+1,x+3); addstr(one_cell); 
    move(y+2,x);
    addstr(two_cells); move(y+2,x+3); addstr(one_cell); 
    move(y+3,x);
    addstr(one_cell); move(y+3,x+2); addstr(two_cells);
    move(y+4,x);
    addstr(one_cell); move(y+4,x+3); addstr(one_cell); 
}
...
void print_g(int x, int y, char cell_type) {
    ...
    addstr(one_cell);
    move(y+2,x);
    addstr(one_cell); move(y+2,x+2); addstr(two_cells); 
    move(y+3,x);
    addstr(one_cell); move(y+3,x+3); addstr(one_cell); 
    move(y+4,x);
    addstr(four_cells);
}
...
void print_m(int x, int y, char cell_type) {
    ...
    char three_cells[4] = {cell_type,cell_type,cell_type};
    move(y,x);
    addstr(one_cell); move(y,x+4);addstr(one_cell); 
    move(y+1, x);
    addstr(two_cells); move(y+1,x+3); addstr(two_cells); 
    move(y+2,x);
    addstr(one_cell); move(y+2,x+2);addstr(one_cell); move(y+2,x+4);addstr(one_cell);
    move(y+3,x);
    addstr(one_cell); move(y+3,x+4);addstr(one_cell); 
    move(y+4,x);
    addstr(one_cell); move(y+4,x+4);addstr(one_cell); 
}
